import { check_name_adress } from "../../helpers";

export class Bottle {    
    constructor(id, category, latlng, icon, name, adress, title, description, mymap, focusOnBottle=true) {        
        this.id = id;
    ...
    removeMarker() {        
        this.mymap.removeLayer(this.markerBottle);
