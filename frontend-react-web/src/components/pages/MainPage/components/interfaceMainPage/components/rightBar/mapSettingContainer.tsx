    ...
    return <div className="right-bar-map-setting-container">
        <div className="right-bar-map-setting-timeLife">
            ...
            <div className="right-bar-map-setting-TL">
                <input className="right-bar-map-setting-TL-hour-input" type={"number"} min="1" max='11' value={1} />
                :
                <input className="right-bar-map-setting-TL-minut-input" type={"number"} min="0" max='59' value={0}/>
            </div>                    
        </div>
        <div className="right-bar-map-setting-pick-count">
            ...
            <input className="right-bar-map-setting-pick-count-input" id="pick-count-input" type={"number"} min='1' value={1}/>
        </div>
    </div>
})